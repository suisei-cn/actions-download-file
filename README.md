...
``` yaml
- uses: suisei-cn/actions-download-file@8fa0a90d8906e99d4af21363cc075538006b1be5 # 1.5.1
...
As git tags can be overwritten, we advise action users to pin to the exact action version by using the commit hash (e.g. `8fa0a90d8906e99d4af21363cc075538006b1be5`) instead of tag name (`v1.5.1`).
